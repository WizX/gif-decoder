#include "com_didikee_gifcodec_GifDecodeInfoHandle.h"
...
extern "C" {
#endif
#define JNIREG_CLASS "com/didikee/gifcodec/GifDecodeInfoHandle"
...
__attribute__((section (".simpletext")))
JNIEXPORT jlong JNICALL Java_com_didikee_gifcodec_GifDecodeInfoHandle_nativeInit
  (JNIEnv *env, jobject)
{
    return (jlong)new GifDecoder();
}
...
__attribute__((section (".simpletext")))
JNIEXPORT void JNICALL Java_com_didikee_gifcodec_GifDecodeInfoHandle_nativeClose
...
__attribute__((section (".simpletext")))
JNIEXPORT jboolean JNICALL Java_com_didikee_gifcodec_GifDecodeInfoHandle_nativeLoad
...
__attribute__((section (".simpletext")))
JNIEXPORT jboolean JNICALL Java_com_didikee_gifcodec_GifDecodeInfoHandle_nativeLoadFromMemory(
...
__attribute__((section (".simpletext")))
JNIEXPORT jint JNICALL Java_com_didikee_gifcodec_GifDecodeInfoHandle_nativeGetFrameCount
  (JNIEnv *, jobject, jlong handle)
{
...
__attribute__((section (".simpletext")))
JNIEXPORT jobject JNICALL Java_com_didikee_gifcodec_GifDecodeInfoHandle_nativeGetFrame
...
__attribute__((section (".simpletext")))
JNIEXPORT jobject JNICALL Java_com_didikee_gifcodec_GifDecodeInfoHandle_renderFrame
...
__attribute__((section (".simpletext")))
JNIEXPORT jint JNICALL Java_com_didikee_gifcodec_GifDecodeInfoHandle_nativeGetDelay
...
__attribute__((section (".simpletext")))
JNIEXPORT jint JNICALL Java_com_didikee_gifcodec_GifDecodeInfoHandle_nativeGetWidth
  (JNIEnv *, jobject, jlong handle)
{
...
__attribute__((section (".simpletext")))
JNIEXPORT jint JNICALL Java_com_didikee_gifcodec_GifDecodeInfoHandle_nativeGetHeight
  (JNIEnv *, jobject, jlong handle)
{
