...
import com.didikee.gifcodec.RequestManager;
...
public class RequestManagerRetriever implements Handler.Callback{
    ...
    private final Map<FragmentManager,SupportRequestManagerFragment>
    ...
    RequestManager supprotFragmentGet(Context context,FragmentManager fm){
        ...
        if (requestManager == null){
            requestManager = new RequestManager(context,current.getSupportLifecycle());
